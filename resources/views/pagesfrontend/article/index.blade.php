                ...
                <div class="row justify-content-between mb-5" data-aos="fade-up">
                    <div class="col-lg-9 mb-5 mb-lg-0 mb-2">
                        <div style="width: 230px; height: 80px;" class="mb-3">
                            <img style="width: 100%; height: 100%; object-fit: cover;" src="{{ asset('assetfrontend/images/home/article/logo.png') }}" alt="">
                        </div>
                        ...
                        <div class="mb-5">
                            <h1 class="mb-4">Daftar Franchise Terbaik 2024 !</h1>
                            <p class="fs-5 text-black mb-5">Lihat daftar franchise terbaik di tahun 2024..</p>
                                ...
                                <div class="col  d-flex align-items-stretch">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-3-line mb-4">Bergabung bersama dengan franchiseterbaik seperti
                                                dokter mobil memberikan akses ke brand yang sudah di uji dukungan pelatihan,
                                                panduan lokasi, kualitas produk yang...</p>
                                            <a href="" class="btn btn-primary py-2 px-3 mt-2 mb-3">VIEW DETAIL</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col  d-flex align-items-stretch">
                                ...
                                <div class="card mb-3">
                                    <a href="">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card-body">
                                                    <p style="font-size: 12px;" class="text-black text-start">TOP COAT INDONESIA </p>
                                                    <p style="font-size: 12px;"><small class="text-primary">Jumat 16 Agustus 2024</small></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
